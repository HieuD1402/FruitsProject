<?php
    ...
    if(isset($_POST['add_category_btn'])){
        ...
        $cate_query="INSERT INTO categories (name,slug,description,meta_title,meta_description,meta_keywords,
        status,popular,image) VALUES ('$name','$slug','$description','$meta_title','$meta_description',
        ...
        if($cate_query_run)
        {
            ...
            redirect("add-category.php","Category added successfuly !");
        }
        else
        {
    ...
    else if(isset($_POST['update_category_btn']))
    {
        ...
        {
            redirect("edit-category.php?id=$category_id","Category update wrong");
        }
    ...
    else if(isset($_POST['add_product_btn']))
    {
        ...
        if($name != "" && $slug != "" && $description != "")
        {
            ...
            selling_price,qty,meta_keywords,status,trending,image) VALUES 
        ...
        else
        {
            ...
            redirect("add-product.php","All fields are mandanory");
        }
    }
    ...
    else if(isset($_POST['update_product_btn']))
    {
        ...
        // meta_description='$meta_description',meta_title='$meta_title'
        ...
        {
            redirect("edit-product.php?id=$product_id","Category update wrong");
        }
    ...
    else if(isset($_POST['delete_product_btn']))
    {
        ...
        {
            // redirect("products.php","product delete wrong");
            echo 500;
        }
    }
    ...
    else if(isset($_POST['update_order_btn']))
    {
        ...
        redirect("view-order.php?t=$track_no","order start update successful");
