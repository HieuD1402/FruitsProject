                                ...
                                <div class="card-body">
                                    <form action="code.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="name" value="<?= $data['name'] ?>" placeholder="Enter category name" 
                                            class="form-control">
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <button tyle="submit" class="btn btn-primary" name="update_category_btn"> Update</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
